    ...
    <div className="grid gap-4">
      ...
      {googleEnabled ? (
        <>
          <div className="relative py-1 text-center text-xs text-muted-foreground">
            <span className="relative z-10 bg-popover px-2">or</span>
      ...
      {message ? (
        <p
          className={
            status === "error"
              ? "rounded-xl border border-red-500/30 bg-red-500/10 px-3 py-2 text-sm text-red-300"
              : "rounded-xl border border-brand/20 bg-brand/5 px-3 py-2 text-sm text-muted-foreground"
          }
